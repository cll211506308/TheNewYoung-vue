<template>
    <div>
      <router-link :to="'/artical/' + articalId">
        <div class="content">
          <img src="http://img4.imgtn.bdimg.com/it/u=2013806720,4152885594&fm=26&gp=0.jpg">
      ...
      <router-link :to="'/artical/' + articalId">
        <div class="content">
          <img src="http://img4.imgtn.bdimg.com/it/u=2013806720,4152885594&fm=26&gp=0.jpg">
          <p style="font-size: 14px">{{result[1].title}}</p><br>
...
<script>
    export default {
      ...
      created(){
          this.$axios.get("http://localhost:3000/fit")
            .then((res) => {
